...
parser.add_argument('--exp', type=str,
                    default='uncertain_aware_mt', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    def create_model(ema=False):
        ...
        net = net_factory_3d(net_type=args.model,
                             in_chns=in_chns, class_num=num_classes)
        model = net.cuda()
        if ema:
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            preds = torch.zeros([stride * T, num_classes, d, w, h]).cuda()
            ...
            preds = preds.reshape(T, stride, num_classes, d, w, h)
            ...
            if iter_num > 0 and iter_num % 1000 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list=val_list_path, num_classes=num_classes, patch_size=args.patch_size,
