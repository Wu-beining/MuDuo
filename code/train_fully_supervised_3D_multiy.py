...
parser.add_argument('--exp', type=str,
                    default='autopet_Fully_Supervised_both_5', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='unet3d_dv', help='model_name')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list=val_list_path, num_classes=13, patch_size=args.patch_size,
