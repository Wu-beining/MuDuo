...
parser.add_argument('--exp', type=str,
                    default='autopet_Cross_Pseudo_Supervision', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    net1 = net_factory_3d(net_type=args.model, in_chns=in_chns, class_num=num_classes).cuda()
    net2 = net_factory_3d(net_type=args.model, in_chns=in_chns, class_num=num_classes).cuda()
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 300 == 0:
                ...
                avg_metric1 = test_all_case(
                    model1, args.root_path, test_list=val_list_path, num_classes=11, patch_size=args.patch_size,
                ...
                avg_metric2 = test_all_case(
                    model2, args.root_path, test_list=val_list_path, num_classes=11, patch_size=args.patch_size,
                    stride_xy=64, stride_z=64,modality = args.modality)
