...
parser.add_argument('--exp', type=str,
                    default='autopet_Fully_Supervised', help='experiment_name')
...
parser.add_argument('--labeled_num', type=int, default=51,
                    help='labeled data')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                avg_metric = test_all_case(
                    model, args.root_path, test_list="val.txt", num_classes=13, patch_size=args.patch_size,
